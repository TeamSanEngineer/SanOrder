          ...
          <!-- HEADER -->
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-12 col-md-12 col-lg-3  ">
                ...
                <!-- <select id="slcnumofteeth" name="slcnumofteeth" class="form-select form-control" >
                        <option value="" hidden selected>Open this select menu</option>
                        <option value="true">true</option>
                        <option value="false">false</option>
                    </select> -->
            ...
            <!-- <div class="form-group row">
                <label class="col-sm-12 col-md-12 col-lg-2 col-form-label labelright ">Drawing Attach File 2:</label>
                <div class="col-sm-12 col-md-12 col-lg-5">
                <div class="input-group">
                    <span  id="txtfupload2" class="form-control"></span>
                    <span class="input-group-btn">
                    <span class="btn btn-primary" onclick="$(this).parent().find('input[type=file]').click();">Browse</span>
                    <input name="file[]" id="file"  accept=".jpg,.png" style="display: block;"  multiple="multiple"  type="file">
